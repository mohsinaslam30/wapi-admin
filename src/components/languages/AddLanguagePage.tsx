      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-8 flex flex-col sm:flex-row sm:items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">{isEditMode ? "Update language details and translation files." : "Set up a new language and upload localization files."}</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 pb-12">
          ...
          <div className="flex items-center justify-end gap-3 pt-6">
            ...
            <Button type="submit" className="px-4.5 py-5 h-12 bg-primary hover:bg-emerald-700 text-white font-bold rounded-lg dark:shadow-none transition-all active:scale-95 disabled:opacity-50 min-w-40" disabled={isLoading || !name || !locale}>
              {isLoading ? (
