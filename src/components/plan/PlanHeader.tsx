...
const PlanHeader = ({ isLoading, onFreeTrialClick, onSyncClick, isSyncing }: PlanHeaderProps) => {
    ...
    <CommonHeader
      ...
      extraActions={
        <div className="flex items-center flex-wrap gap-3">
          ...
          <Can permission="update.plans">
            <Button variant="outline" onClick={onSyncClick} disabled={isLoading || isSyncing} className="flex items-center gap-2 px-4.5 py-5 rounded-lg border-(--card-border-color) bg-white dark:bg-(--card-color) text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800 transition-all shadow-sm">
